        ...
        switch($input_type)
        {
            ...
            default:
                ...
                if( ! is_array( $value ) ) {
                    ...
                    $allow_html = in_array($field["type"], array("post_custom_field", "post_title", "post_content", "post_excerpt", "post_tags", "password" )) || in_array($input_type, array("checkbox", "radio")) ? true : false;
